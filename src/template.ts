...
export type TemplateFunc<E extends Entity, P extends TemplateParams> = (params:P)=>EntityPushParams<E>

export interface Template<E extends Entity, P extends TemplateParams = TemplateParams> {
  create(params:P):E
}
